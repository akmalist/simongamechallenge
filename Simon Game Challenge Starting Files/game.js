...
//when user clicked and picked a color
...
function checkAnswer(currentLevel) {
    ...
    if (gamePattern[currentLevel] === userClickedPattern[currentLevel]) {
     ...
     /*1. In the sounds folder, there is a sound called wrong.mp3,
    play this sound if the user got one of the answers wrong.*/
    playSound("wrong");
    /*2. In the styles.css file, there is a class called "game-over",
    ...
    //change the h1 once the user selects wrong answers
